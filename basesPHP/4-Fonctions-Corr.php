...
<br/>Code PHP ?<br/>
<?php
function afficherPremier($param1,$param2){
  return $param1;
}
echo 'Test: le premier paramètre entre AAAA et BBBB est: '.afficherPremier('AAAA','BBBB');
 ?>
...
<br/>Code PHP ?<br/>
<?php
function plusGrand($param1,$param2){
  if($param1>$param2){
    return $param1;
  }
  else{
...
echo 'Test: le plus grand nombre entre 0 et 100 est: '.plusGrand(0,100);
 ?>
